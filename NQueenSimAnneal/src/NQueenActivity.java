...
public class NQueenActivity extends Application implements EventHandler<ActionEvent>{
	...
	public void handle(ActionEvent event) {
		if (runApp == event.getSource()) {
			...
			iterations.setText("Iterations: " + controller.getIterations());
		}
	...
	public void start(Stage stage) throws Exception {
		...
		center.getChildren().addAll(runApp, finalArray, initArray, enterN, iterations);
